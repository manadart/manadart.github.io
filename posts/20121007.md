...
The technique below uses what's known as a _Metaclass_. It comes courtesy of the enigmatic [_why](http://en.wikipedia.org/wiki/Why_the_lucky_stiff). To read more about the concept specifically, check out [this](http://dannytatom.me/metaid) post.
